...
export const Layout = ({ children, title = 'Join Twitter today.' }: LayoutProps) => {
  return (
    <>
      <div>
            ...
            <div className="md:flex md:items-center md:justify-left w-full sm:w-auto md:h-full xl:w-1/2 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none ">
              <div className="max-w-xl w-full space-y-12">
                <div className="lg:text-left text-center">
                  ...
                  <h2 className="mt-6 text-7xl font-bold text-gray-100">Happening now</h2>
                  <p className="mt-10 text-4xl text-gray-200">{title}</p>
                </div>
