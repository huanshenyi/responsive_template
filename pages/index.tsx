      ...
      <div className="card card-side bg-base-200 shadow-xl">
        <div className="card-body">
          ...
          <p>
            ...
            dolor purus non enim. Purus viverra accumsan in nisl. Aliquam
            faucibus purus in massa. In vitae turpis massa sed elementum tempus
            egestas. Nisl purus in mollis nunc sed. Ullamcorper morbi tincidunt
            ornare massa eget. Enim nulla aliquet porttitor lacus luctus
            accumsan. Id neque aliquam vestibulum morbi blandit cursus.
            Pellentesque eu tincidunt tortor aliquam nulla facilisi cras. Sed
      ...
      <div className="card card-side bg-base-200 shadow-xl">
        <div className="card-body">
          ...
          <p>
            ...
            integer. Massa sed elementum tempus egestas sed. Proin sagittis nisl
            rhoncus mattis rhoncus urna. Amet volutpat consequat mauris nunc
            congue nisi vitae suscipit tellus. Posuere urna nec tincidunt
            praesent semper. Elementum pulvinar etiam non quam lacus
            suspendisse.
          </p>
        </div>
      </div>
      <div className="card card-side bg-base-200 shadow-xl">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            potenti nullam ac tortor vitae purus. Eu mi bibendum neque egestas
